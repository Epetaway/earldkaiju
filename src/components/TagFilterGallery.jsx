...
const loadImages = async () => {
  ...
  const folder1Images = require.context('public/fixed/images/illustrations', false, /\.(png|jpe?g|svg)$/);
  ...
  const folder3Images = require.context('public/fixed/images/designs', false, /\.(png|jpe?g|svg)$/);
