...
Card.Eyebrow = function CardEyebrow({ as: Component = "p" , decorate =false , className , children , ...props }) {
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(Component, {
        className: clsx__WEBPACK_IMPORTED_MODULE_2___default()(className, "relative z-10 order-first mb-3 flex items-center text-sm text-zinc-500 dark:text-zinc-500", decorate && "pl-3.5"),
        ...props,
        children: [
